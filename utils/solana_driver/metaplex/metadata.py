...
def get_metadata(client, mint_key):
    ...
    """contract_metadata = {
        'update_authority': b'Fc919Dyu9V9Z63AbZv3Tw8d4bf48gRH8TPY3TVk9CfZw',
        'mint': b'F4jummNvW2NAATcJmGPVTA3jpDyvNcKdv2bp9n2jXsqJ',
        'data': {
            'name': 'Chronicle NFT',
            'symbol': 'XNFT',
            'uri': 'https://stage.xnl.zpoken.io/nft/id/24',
            'seller_fee_basis_points': 0,
            'creators': [b'Fc919Dyu9V9Z63AbZv3Tw8d4bf48gRH8TPY3TVk9CfZw'],
            'verified': [1],
            'share': [100]
        },
